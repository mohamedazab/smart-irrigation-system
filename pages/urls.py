...
from .views import create_plant, retrieve_plant, sign_up, log_in, add_plant_to_grid, refresh, set_current_moisture, log_out

urlpatterns = [
    path('api/login', log_in, name='login'),
    path('api/logout', log_out, name='logout'),
